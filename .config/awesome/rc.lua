...
fontSmall = "Source Code Pro Regular 9"
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span font="' .. font .. '" background="#C2C2A4"><span color="#FFFFFF">' .. args["{" .. interface .. " down_kb}"] .. 'kbps' .. '</span></span>' end, 10)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="' .. font .. '"><span color="#FFFFFF" background="#92B0A0">$2% </span></span>', 30, "BAT0" )
...
'<span background="#4B3B51" font="' .. font .. '"><span color="#EEEEEE"> $1 </span></span>', 0.3, "Master")
